...
class NowPlayingSeriesList extends StatelessWidget {
  const NowPlayingSeriesList({super.key});
                    ...
                    onTap: () {
                      Navigator.pushNamed(context, Movepage.routeName,
                          arguments: MoviePageModel(
                            firebaseId: '',
                            name:
                            Nowplayingmoving[index].name ?? "",
                            date: Nowplayingmoving[index].firstAirDate ?? "",
                            votecount:
