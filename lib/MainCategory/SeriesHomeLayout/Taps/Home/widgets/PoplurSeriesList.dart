...
class PoplurSeriesList extends StatelessWidget {
  PoplurSeriesList( {super.key});
                ...
                onTap: () {
                  Navigator.pushNamed(context, Movepage.routeName,
                      arguments: MoviePageModel(
                        firebaseId: '',
                        name: PoplurMovies[index].name ?? "",
                        date: PoplurMovies[index].firstAirDate ?? "",
                                  ...
                                  onTap: () {
                                    MoviePageModel movie = MoviePageModel(
                                        ...
                                        name: PoplurMovies[index]
                                            .name,
                                        date:
                                        PoplurMovies[index].firstAirDate,
                                        votecount:
