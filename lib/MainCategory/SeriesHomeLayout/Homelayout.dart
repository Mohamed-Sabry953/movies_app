...
class SeriesHomelayout extends StatefulWidget {
  static const String routeName = 'serieshome';

  @override
  State<SeriesHomelayout> createState() => _SeriesHomelayoutState();
}

class _SeriesHomelayoutState extends State<SeriesHomelayout> {
  int currentIndex=0;
  List<Widget>Taps=[SeriesHomeTap(),SeriesSearchTap(),SeriesBrowserTap(),SeriesWatchList()];
